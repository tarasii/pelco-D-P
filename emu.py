...
v_addr = tk.StringVar()
e_addr = tk.Entry(frame, textvariable=v_addr)
e_addr.grid(column=0, row=0, columnspan=4)
...
frc.grid(column=5, row=0, rowspan=5)
...
b_cam.grid(column=1, row=4, columnspan=2)
